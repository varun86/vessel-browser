...
- After clicking or submitting a form, use read_page to see the updated content — but only if the result isn't obvious from context (e.g. search results after searching).
